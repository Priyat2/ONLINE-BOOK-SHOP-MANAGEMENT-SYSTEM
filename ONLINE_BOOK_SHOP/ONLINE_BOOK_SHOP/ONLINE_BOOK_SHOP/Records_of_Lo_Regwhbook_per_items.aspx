<%@ Page Title="Local- Order Details" Language="C#" MasterPageFile="~/Mainsite.Master" AutoEventWireup="true" CodeBehind="Records_of_Lo_Regwhbook_per_items.aspx.cs" Inherits="ONLINE_BOOK_SHOP.Records_of_Lo_Regwhbook_per_items" %>
                        ...
                        <div class="panel-body">
                           <%-- <span class="form-group form-group-lg-4 form-inline pull-right">
                            ...
                            <div>
                                ...
                                <span class="form-group form-group-lg-4 form-inline pull-right"><b>Receive Date : </b>
                            ...
                            <div class="row">
                                <div class="column">
                                    <label style="padding-left:15px;"><b>Shop Name :</b></label>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            <td style="display: none;">
                                                <asp:Label ID="lbltrpoid" runat="server" Text='<%# Eval("pk_trlo_id") %>' /></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.book_item_name")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_item_qty")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_item_price")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_tax_percent")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_discount_percent")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.final_price")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_item_qty")%></td>
                                            <td><%# DataBinder.Eval(Container, "DataItem.trlo_bonus_qty")%></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </table>
