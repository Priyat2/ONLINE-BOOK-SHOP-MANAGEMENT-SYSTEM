<%@ Page Title="Book Supplier- Order Records" Language="C#" MasterPageFile="~/Mainsite.Master" AutoEventWireup="true" CodeBehind="Records_of_Book_Purchase_Order.aspx.cs" Inherits="ONLINE_BOOK_SHOP.Records_of_Book_Purchase_Order" %>
                                ...
                                <asp:Repeater ID="Repeater" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td><%--<button id="btnid" onclick='next(<%# Eval("pk_po_id") %>)' class="btn btn-info">View Items</button> --%>
                                                <asp:LinkButton ID="btnid" runat="server" OnClientClick='<%# "next(" + Eval("pk_po_id") + "); " %>' Style="color: blue;" Text='<img src="images/view.png">'></asp:LinkButton>
                                                |
