<%@ Page Title="Center- Confirm Order" Language="C#" MasterPageFile="~/Mainsite.Master" AutoEventWireup="true" CodeBehind="complete_req_from_wh_to_bookcitywh.aspx.cs" Inherits="ONLINE_BOOK_SHOP.complete_req_from_wh_to_bookcitywh" %>
                                ...
                                <asp:Repeater ID="Repeater" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="txtconfirm" Text=""></asp:TextBox></td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                        </table>
