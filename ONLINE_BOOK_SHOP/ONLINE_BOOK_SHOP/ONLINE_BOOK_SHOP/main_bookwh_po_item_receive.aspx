<%@ Page Title="Supplier- Receive Item" Language="C#" MasterPageFile="~/Mainsite.Master" AutoEventWireup="true" CodeBehind="main_bookwh_po_item_receive.aspx.cs" Inherits="ONLINE_BOOK_SHOP.main_bookwh_po_item_receive" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="row">
                                <div class="column">
                                    <label style="padding-left:15px;"><b>Supplier Name :</b></label>
                                        <asp:Label Style="padding-left: 15px;" runat="server" Text="" ID="lblsplrname"></asp:Label>
                                </div>
                                <div class="column">
                                ...
                                <div class="column">
                                    <label><b>Order price : </b></label>
                                        <asp:Label Style="padding-left: 15px;" runat="server" Text="" ID="lbltotalprice"></asp:Label>
                                </div>
                               </div>
                            <div class="row">
                                <div class="column" >
                                ...
                                <div class="column">
                                        <label><b>GRN : </b></label>
                                       <asp:TextBox runat="server" ID="txtgrn" CssClass="form-control" style="width:200px;" Text=""></asp:TextBox>
                                 ...
                                 <asp:Repeater ID="Repeater" runat="server">
                                        ...
                                        <tr >
                                            <td style="display: none;">
                                              ...
                                              <td style="display: none;">
                                                <asp:Label ID="lblpoid" runat="server" Text='<%# Eval("trpo_fk_po_id") %>' /></td>

                                            <td style="display: none;">
                                                <asp:Label ID="lblitemid" runat="server" Text='<%# Eval("trpo_fk_item_id") %>' /></td>
                                            ...
                                            <td><%# DataBinder.Eval(Container, "DataItem.trpo_item_qty")%></td>
                                             ...
                                             <td>
                                                <asp:TextBox runat="server" CssClass ="form-control" style="width:80px;" onkeyup="calculate(this)"    ID="txtrecieved" Text='<%# Eval("trpo_item_qty") %>'></asp:TextBox></td>
                                            ...
                                            <td > <asp:Label runat="server" ID="lbltqty" Text='<%# Eval("total") %>'  ></asp:Label></td>
                                              ...
                                              <td><asp:TextBox runat="server"  CssClass ="form-control" style="width:80px;" ID="txtbatch" Text=""></asp:TextBox></td>

                                             <td><asp:TextBox runat="server"  CssClass ="form-control" style="width:130px;"  textmode="Date" ID="txtexpiry" Text=""></asp:TextBox> </td>

                                            <td><asp:TextBox runat="server" CssClass ="form-control" style="width:80px;" onkeyup="calculate(this)" ID="txtpriper" Text='<%# Eval("trpo_item_price") %>'></asp:TextBox></td>
                                            
                                            <td><asp:TextBox runat="server"  CssClass ="form-control" style="width:80px;" onkeyup="calculate(this)" ID="txtrate" Text='<%# Eval("trpo_tax_percent") %>'></asp:TextBox></td>

                                             <td><asp:TextBox runat="server"  CssClass ="form-control" style="width:80px;" onkeyup="calculate(this)" ID="txtdisc" Text='<%# Eval("trpo_discount_percent") %>'></asp:TextBox></td>
    ...
    <script type="text/javascript">
                           $(function () {
                               $(".txtDateCss").datepicker({ format: 'dd/mm/yy' });
                                 });
                             </script>
