...
{
    public partial class complete_req_from_wh_to_bookcitywh : System.Web.UI.Page
    {
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem item in Repeater.Items)
            {
                ...
                Label item_id = (Label)item.FindControl("lblitemid");
                {
                    ...
                    dt1 = MainWarehouse.bookconfirm_qty_i(txtqty.Text, fk_id.Text, pk_id.Text, locationid.Value, nameCookie.Value);

                }
                DataTable dt2 = new DataTable();
                dt2 = MainWarehouse.complete_book_center_req_stock_minus(txtqty.Text, item_id.Text, locationid.Value);
